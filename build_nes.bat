...
gcc bin\nes_cpu.o bin\nes_ppu.o bin\emu_nes.o bin\controller.o bin\cartridge.o bin\nrom00.o bin\unrom02.o bin\nes_apu.o bin\arach_movie.o -IC:\C_Libraries\include\SDL2 -LC:\C_Libraries\lib -w -Wl,-subsystem,windows -lmingw32 -lSDL2main -lSDL2 -o bin\arach_movie.exe -Wall -Wextra -m32